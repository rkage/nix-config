  ...
  xsession.windowManager.i3 =
    let
      ...
      resizeMode =
        "󰩨 : (h) (j) (k) (l)";
      powerManagementMode =
        " : System [e]xit, [R]eboot, [S]hutdown";
    ...
    in
    {
      ...
      config = {
        ...
        colors = {
          background = "#1e2128";
          focused = { border = accent; background = bgdark; text = fglight; indicator = indicator; childBorder = accent; };
          focusedInactive = { border = bglight; background = bgdark; text = fgdark; indicator = indicator; childBorder = bglight; };
          unfocused = { border = bgdark; background = bgdark; text = fgdark; indicator = indicator; childBorder = bgdark; };
          urgent = { border = urgent; background = bgdark; text = fglight; indicator = indicator; childBorder = urgent; };
          placeholder = { border = bgdark; background = bgdark; text = fglight; indicator = indicator; childBorder = bgdark; };
        };
